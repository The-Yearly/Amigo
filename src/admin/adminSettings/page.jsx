...
const Cards = ({ card }) => {
  return (
    <div className="w-full rounded-xl bg- col-span-1 grid grid-cols-2 px-4 sm:px-6 py-5  shadow-sm hover:shadow-md transition-shadow">
      <div
...
export default function AdminHome() {
  ...
  return (
    <div className="max-w-full mt-8 gap-6 px-12 grid grid-cols-1 md:grid-cols-5">
      ...
      {!isMobile && (
        <React.Fragment>
          ...
          <div className="col-span-1 col-start-1 md:col-start-3 flex items-center justify-center">
            <div className="border space-x-4 border-gray-400 rounded-2xl flex justify-center mt-5 w-fit px-5 py-2">
              <p>Load More </p>
              <ChevronDown />
            </div>
          </div>
