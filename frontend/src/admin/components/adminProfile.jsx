...
const AdminProfile = () => {
  ...
  const admin = {
    ...
    permissionScope:
      "Unrestricted platform access. Can modify core architecture.",
          ...
          <div className="lg:col-span-2 space-y-8">
            <section className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100 flex items-center gap-8">
              <div className="relative">
                ...
                <div
                  className={`absolute -bottom-2 -right-2 w-6 h-6 rounded-full border-4 border-white ${isSuperAdmin ? "bg-purple-500" : "bg-slate-400"}`}
                />
              </div>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100 space-y-8">
              ...
              <div className="pt-6 border-t border-gray-100">
                <p className="text-sm text-gray-500 mb-6 leading-relaxed font-medium">
                  Update your security credentials to maintain platform
                  integrity.
                </p>
