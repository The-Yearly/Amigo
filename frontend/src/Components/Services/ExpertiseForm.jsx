    ...
    >
      ...
      <section className="mb-10">
        ...
        <p className="text-sm text-gray-400 mb-6">
          Upload up to 5 high-resolution images of your work.
        </p>
        ...
        <div className="grid grid-cols-4 gap-4">
          ...
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="aspect-square bg-[#F3F3F3] border-2 border-dashed border-gray-200 rounded-xl flex items-center justify-center text-gray-300 text-2xl hover:bg-gray-50 cursor-pointer"
            >
              +
            </div>
          ))}
      ...
      <div className="mt-12 pt-8 border-t border-gray-100 flex justify-between items-center">
        ...
        <p className="text-[10px] text-gray-400 flex items-center gap-2">
          <span className="w-2 h-2 bg-gray-300 rounded-full"></span> Auto-saved
          at 10:42 AM
        </p>
        <div className="flex gap-4">
          ...
          <button
            type="button"
            className="bg-[#f08fb3] text-white px-8 py-3 rounded-lg font-bold text-sm hover:opacity-90"
          >
            Save Draft
          </button>
          ...
          <button
            type="submit"
            className="bg-[#064e3b] text-white px-8 py-3 rounded-lg font-bold text-sm hover:bg-green-900"
          >
            Publish Post
          </button>
        </div>
