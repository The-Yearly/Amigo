...
export default function RequestDetailPanel({
  ...
  return (
    <aside className="lg:col-span-4 sticky top-28 bg-surface-container-lowest rounded-xl shadow-ambient overflow-hidden">
      {/* Header */}
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              {attachments.map((att, i) => (
                <div
                  key={i}
                  className="flex items-center gap-3 p-3 bg-surface-container rounded-lg border border-outline-variant/10"
                >
